    ...
    def get_response(self, msg):
        ...
        for tg in self.data_indonesia['intents']:
            if tg['tag'] == intent[0]:
                ...
                return "I apologize for any confusion. Could you please rephrase your message, so I can better understand and assist you?"
